<%@ Page Title="" Language="C#" MasterPageFile="~/View/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Rentals.aspx.cs" Inherits="CarRental.View.Admin.Rentals" %>
<asp:Content ID="Content1" ContentPlaceHolderID="myBody" runat="server">
        ...
        <div class="row">
            <div class="rentalInfo">
                <div class="row">
                    <div class="col">
                        <h4 class="text-warning pe-lg-4">Manage Rented Cars</h4>
                        <img src="../../Assets/Images/Cars/car-regular-240.png" />
                    </div>
                    <div class="col"></div>
                    <div class="col"></div>
                </div>
